...
# fmt: off
KNOWN_STDLIB_MODULE_NAMES = frozenset((
    # ref: https://github.com/mgedmin/findimports/blob/master/findimports.py
    # below is taken from python 3.14.
    '__future__',
    ...
    'csv', 'ctypes', 'curses', 'cython_runtime',
...
class ModuleInspector:
    ...
    def find_module_path(self, module: T.ModuleInfo) -> T.FilePath:
        ...
        if module.top in KNOWN_STDLIB_MODULE_NAMES:
